...
extern void zt_bstream_set_data(zt_bstream bs, unsigned char *data, int len, char copy);
...
extern size_t zt_bstream_read(zt_bstream bs, unsigned char *buf, size_t len, char size, char tag);
extern void zt_bstream_read_byte(zt_bstream bs, unsigned char *data);
...
extern void zt_write_bytes(unsigned char *s, unsigned char *d, size_t len, int flip);

extern size_t zt_bstream_write(zt_bstream bs, unsigned char *data, size_t len, char szie, char tag);
extern void zt_bstream_write_byte(zt_bstream bs, unsigned char data);
