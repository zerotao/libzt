 ...
 */
int
zt_cstr_any(const char *s, int i, const char *set)
{
    int len;
...
/*!
 * locates the first occurrence of any string not in set in the string
 * referenced by s[i:j]
 */
int
zt_cstr_many(const char *s, int i, int j, const char *set)
{
    zt_assert(set);
...
/*!
 * locates the last occurrence of any string not in set in the string
 * referenced by s[i:j]
 */
int
zt_cstr_rmany(const char *s, int i, int j, const char *set)
{
    zt_assert(set);
 ...
 */
int
zt_cstr_match(const char *s, int i, int j, const char *str)
{
    int len;
 ...
 */
int
zt_cstr_rmatch(const char *s, int i, int j, const char *str)
{
    int len;
