...
struct zt_set {
    zt_table * tbl;
    long       length;
    int        (*match)(const void *key1, size_t key1_len, const void *key2, size_t key2_len, void *cdata);
...
zt_set *zt_set_init(int (*match)(const void *key1, size_t key1_len, const void *key2, size_t key2_len, void *cdata),
                    void (*destroy)(void *data),
                    void *cdata);

void zt_set_destroy(zt_set *set);
int zt_set_insert(zt_set *set, const void *data, size_t len);
...
int zt_set_is_member(const zt_set *set1, const void *data, size_t len);
